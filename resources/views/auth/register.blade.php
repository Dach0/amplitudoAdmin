...
@section('content')
<div class="d-flex flex-column vh-100 container justify-content-center">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="user_img" class="col-md-4 col-form-label text-md-right">{{ __('Izaberi sliku') }}</label>

                            <div class="col-md-6">
                                <input id="user_img" type="file" name="user_image">
                                @if ($errors->has('user_image'))
                                    <div class="bg-danger">Ili nije dobar format slike ili je slika preko 2MB</div>
                                    {{$errors->has('user_image')}}
                                @endif
                            </div>
                        </div>
